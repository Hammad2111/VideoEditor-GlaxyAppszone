...
public class MyVideoFragment extends Fragment {
    ...
    private class a extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                MyVideoFragment.this.a = new MyVideoAdapter(MyVideoFragment.this.getActivity(), MyVideoFragment.this.arrayList, MyVideoFragment.this.b);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
         inflate = layoutInflater.inflate(R.layout.videomyfragment, viewGroup, false);
    ...
    public boolean b() {
        if (Helper.ModuleId == 1) {
          ...
          this.f = new String[]{sb.toString()};
            ...
            folderName = getResources().getString(R.string.VideoCutter);
          ...
          sb2.append(getResources().getString(R.string.VideoCompressor));
           ...
           this.f = new String[]{sb2.toString()};
            ...
            folderName = getResources().getString(R.string.VideoCompressor);
            ...
            folderName = getResources().getString(R.string.VideoToMP3);
          ...
          this.e = "_data like?";
           ...
           this.f = new String[]{sb3.toString()};
            ...
            folderName = getResources().getString(R.string.AudioVideoMixer);
          ...
          sb4.append(getResources().getString(R.string.VideoMute));
           ...
           this.f = new String[]{sb4.toString()};
            ...
            folderName = getResources().getString(R.string.VideoMute);
          ...
          StringBuilder sb5 = new StringBuilder();
           ...
           sb5.append("/");
            ...
            folderName = getResources().getString(R.string.VideoConverter);
           ...
           sb6.append(getResources().getString(R.string.FastMotionVideo));
            ...
            folderName = getResources().getString(R.string.FastMotionVideo);
          ...
          sb7.append("%");
           this.f = new String[]{sb7.toString()};
            ...
            folderName = getResources().getString(R.string.SlowMotionVideo);
          ...
          sb8.append(getResources().getString(R.string.VideoCroper));
           ...
           this.f = new String[]{sb8.toString()};
            ...
            folderName = getResources().getString(R.string.VideoCroper);
           ...
           sb9.append("%");
            ...
            folderName = getResources().getString(R.string.VideoRotate);

        } else if (Helper.ModuleId == 14) {
          this.e = "_data like?";
           StringBuilder sb10 = new StringBuilder();
           sb10.append("%");
           sb10.append(getResources().getString(R.string.MainFolderName));            sb10.append("/");
            sb10.append(getResources().getString(R.string.VideoMirror));
            sb10.append("%");
            this.f = new String[]{sb10.toString()};

            folderName = getResources().getString(R.string.VideoMirror);
...
//            this.f = new String[]{sb11.toString()};
            ...
            folderName = getResources().getString(R.string.VideoSplitter);
...
//            this.f = new String[]{sb12.toString()};
            folderName = getResources().getString(R.string.VideoReverse);
...
//            this.f = new String[]{sb13.toString()};
            ...
            folderName = getResources().getString(R.string.VideoWatermark);
        }
...
//        return true;
        ...
        String path = getContext().getExternalFilesDir(null) + "/VEditor/" + "/" + folderName + "/";
