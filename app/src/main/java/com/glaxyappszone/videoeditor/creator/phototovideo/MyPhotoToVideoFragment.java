    ...
    private class a extends AsyncTask<Void, Void, Boolean> {
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (bool.booleanValue()) {
                MyPhotoToVideoFragment.this.a = new MyPhotoToVideoAdapter(MyPhotoToVideoFragment.this.getActivity(), MyPhotoToVideoFragment.this.arrayList, MyPhotoToVideoFragment.this.b);
...
//        return true;
        ...
        String path = getContext().getExternalFilesDir(null) + "/VEditor/" + "/"+getResources().getString(R.string.PhotoToVideo)+"/";
