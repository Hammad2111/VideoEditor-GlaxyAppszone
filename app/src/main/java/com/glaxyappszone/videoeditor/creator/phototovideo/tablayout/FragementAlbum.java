...
import com.glaxyappszone.videoeditor.creator.phototovideo.model.GallaryAlbum;
...
public class FragementAlbum extends Fragment {
    ...
    public class RecyclerGallaryAlbumAdapter extends Adapter<RecyclerGallaryAlbumAdapter.holder> {
        ...
        public void onBindViewHolder(holder aVar, @SuppressLint("RecyclerView") final int i) {
            if (Utils.width < 1) {
